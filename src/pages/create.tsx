...
export default function CreatePoll() {
    ...
    return (
        <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center gap-4 px-2 lg:px-0">
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="mt-6">
                            <label className="block text-sm font-medium text-neutral-700">
                                Options (min options 2, max characters 85){" "}
                            </label>
                            <div className="mt-2">
